...
module instruction_memory(
   ...
   initial begin
        ...
        memory[1] = 16'b0011001000100010;  // addi r2 r2 2
        
        memory[2] = 16'b0000001100100000;  // Example instruction (add) r3 r2
        memory[3] = 16'b0000001100010001;  // Example instruction (add)

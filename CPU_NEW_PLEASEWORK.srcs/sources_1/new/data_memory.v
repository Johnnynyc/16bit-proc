...
module Data_Memory(
    ...
    always @ (posedge clk) begin
      ...
      initial begin
        ...
        //$monitor("Time inside DATAMEM: %t WE: %h | RE: %h | sourceAdd: %h | inputdata: %h | OutputData : %h | MEM[1]: %h| MEM[2]: %h | 3 : %h | 4: %h", 
        //$time, WriteEnable, ReadEnable, SourceAddress, InputData, OutputData, memory[1], memory[2], memory[3], memory[4]);
  end
